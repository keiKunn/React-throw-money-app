...
const RegistUser = () => {
  ...
  return (
    <div>
      <h2>新規登録</h2>
      <InputTextForm name="UserName" labelName="ユーザ名" type="text"
      ...
      <InputTextForm name="ConfirmPassword" labelName="パスワードの確認" type="password"
        value={confirmPassword} onChange={inputConfirmPassword} />

      <Button value="アカウント登録" onClick={() => dispath(pushRegistUser(username, email, password, confirmPassword))} />
